...
#define MOVE_PSYBLADE 0x317
#define MOVE_HYDROSTEAM 0x318
#define MOVE_RUINATION 0x319
#define MOVE_COLLISIONCOURSE 0x31A
#define MOVE_ELECTRODRIFT 0x31B
#define MOVE_SHEDTAIL 0x31C
#define MOVE_CHILLYRECEPTION 0x31D
#define MOVE_TIDYUP 0x31E
#define MOVE_SNOWSCAPE 0x31F
#define MOVE_POUNCE 0x320
#define MOVE_TRAILBLAZE 0x321
#define MOVE_CHILLINGWATER 0x322
#define MOVE_HYPERDRILL 0x323
#define MOVE_TWINBEAM 0x324
#define MOVE_RAGEFIST 0x325
#define MOVE_ARMORCANNON 0x326
#define MOVE_BITTERBLADE 0x327
#define MOVE_DOUBLESHOCK 0x328
#define MOVE_GIGATONHAMMER 0x329
#define MOVE_COMEUPPANCE 0x32A
#define MOVE_AQUACUTTER 0x32B
#define MOVE_BLAZINGTORQUE 0x32C
#define MOVE_WICKEDTORQUE 0x32D
#define MOVE_NOXIOUSTORQUE 0x32E
#define MOVE_COMBATTORQUE 0x32F
#define MOVE_MAGICALTORQUE 0x330
#define MOVE_SYRUPBOMB 0x331
#define MOVE_BLOODMOON 0x332
#define MOVE_MATCHAGOTCHA 0x333
#define MOVE_IVYCUDGEL 0x334
#define MOVE_ELECTROSHOT 0x335
#define MOVE_TERASTARSTORM 0x336
#define MOVE_FICKLEBEAM 0x337
#define MOVE_BURNINGBULWARK 0x338
#define MOVE_THUNDERCLAP 0x339
#define MOVE_MIGHTYCLEAVE 0x33A
#define MOVE_TACHYONCUTTER 0x33B
#define MOVE_HARDPRESS 0x33C
#define MOVE_DRAGONCHEER 0x33D
#define MOVE_ALLURINGVOICE 0x33E
#define MOVE_TEMPERFLARE 0x33F
#define MOVE_SUPERCELLSLAM 0x340
#define MOVE_PSYCHICNOISE 0x341
#define MOVE_UPPERHAND 0x342
