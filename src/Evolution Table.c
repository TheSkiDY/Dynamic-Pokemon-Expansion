...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_KAKUNA] =           {{EVO_LEVEL, 10, SPECIES_BEEDRILL, 0},
								  {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_BEEDRILL_S, 0}},
	...
	[SPECIES_GOLBAT] =           {{EVO_FRIENDSHIP, 0, SPECIES_CROBAT, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_CROBAT, 0}},
	...
	[SPECIES_DIGLETT] =          {{EVO_LEVEL, 26, SPECIES_DUGTRIO, 0},
								  {EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_DEMOLETT, 0}},
	...
	[SPECIES_MAGNETON] =         {{EVO_MAP, MAP_NAME_POWER_PLANT, SPECIES_MAGNEZONE, 0}},
	...
	[SPECIES_EXEGGCUTE] =        {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR, 0}, 
								  {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_EXEGGUTOR_A, 0}},
	...
	[SPECIES_KOFFING] =          {{EVO_LEVEL, 35, SPECIES_WEEZING, 0},
								  {EVO_MAP, MAP_NAME_MT_EMBER, SPECIES_WEEZING_G, 0},
								  {EVO_ITEM, ITEM_SHINY_STONE, SPECIES_WEEZING_G, 0}},
	...
	[SPECIES_CHANSEY] =          {{EVO_FRIENDSHIP, 0, SPECIES_BLISSEY, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_BLISSEY, 0}},
	...
	[SPECIES_EEVEE] =            {{EVO_FRIENDSHIP_DAY, 0, SPECIES_ESPEON, 0},
								  {EVO_ITEM_DAY, ITEM_EMPATHY_ROCK, SPECIES_ESPEON, 0},
								  {EVO_FRIENDSHIP_NIGHT, 0, SPECIES_UMBREON, 0},
								  {EVO_ITEM_NIGHT, ITEM_EMPATHY_ROCK, SPECIES_UMBREON, 0},
	...
	[SPECIES_LANTURN] =  		 {{EVO_MEGA, ITEM_LANTURNITE, SPECIES_LANTURN_MEGA, MEGA_VARIANT_STANDARD}},
	[SPECIES_PICHU] =            {{EVO_FRIENDSHIP, 0, SPECIES_PIKACHU, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_PIKACHU, 0}},
	[SPECIES_CLEFFA] =           {{EVO_FRIENDSHIP, 0, SPECIES_CLEFAIRY, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_CLEFAIRY, 0}},
	[SPECIES_IGGLYBUFF] =        {{EVO_FRIENDSHIP, 0, SPECIES_JIGGLYPUFF, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_JIGGLYPUFF, 0}},
	[SPECIES_TOGEPI] =           {{EVO_FRIENDSHIP, 0, SPECIES_TOGETIC, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_TOGETIC, 0}},
	...
	[SPECIES_SUNKERN] =          {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_SUNFLORA, 0},
								  {EVO_ITEM, ITEM_MOON_STONE, SPECIES_SUNFLORA_S, 0}},
	...
	[SPECIES_OCTILLERY] =  		 {{EVO_MEGA, ITEM_OCTILLERITE, SPECIES_OCTILLERY_MEGA, MEGA_VARIANT_STANDARD}},
	...
	[SPECIES_WURMPLE] =          {{EVO_NATURE_LOW, 7, SPECIES_SILCOON, 0},
								  {EVO_NATURE_HIGH, 7, SPECIES_CASCOON, 0}},
	...
	[SPECIES_SWELLOW] =  		 {{EVO_MEGA, ITEM_SWELLOWITE, SPECIES_SWELLOW_MEGA, MEGA_VARIANT_STANDARD}},
	...
	[SPECIES_SKITTY] =           {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_DELCATTY, 0},
								  {EVO_ITEM, ITEM_REAPER_CLOTH, SPECIES_DELCATTY_S, 0}},
	[SPECIES_BALTOY] =           {{EVO_LEVEL, 36, SPECIES_CLAYDOL, 0}},
	[SPECIES_NOSEPASS] =         {{EVO_MAP, MAP_NAME_POWER_PLANT, SPECIES_PROBOPASS, 0}},
	...
	[SPECIES_SNORUNT] =          {{EVO_LEVEL, 42, SPECIES_GLALIE, 0},
								  ...
								  {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_FROSLASS_S, MON_FEMALE}},
	...
	[SPECIES_AZURILL] =          {{EVO_FRIENDSHIP, 0, SPECIES_MARILL, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_MARILL, 0}},
	...
	[SPECIES_BUDEW] =            {{EVO_FRIENDSHIP_DAY, 0, SPECIES_ROSELIA, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_ROSELIA, 0}},
	...
	[SPECIES_COMBEE] =           {{EVO_FEMALE_LEVEL, 21, SPECIES_VESPIQUEN, 0},
								  {EVO_MALE_LEVEL, 21, SPECIES_VESPIKING, 0}},
	...
	[SPECIES_BUNEARY] =          {{EVO_FRIENDSHIP, 0, SPECIES_LOPUNNY, 0},
						          {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_LOPUNNY, 0}},
	...
	[SPECIES_CHINGLING] =        {{EVO_FRIENDSHIP_NIGHT, 0, SPECIES_CHIMECHO, 0},
								  {EVO_ITEM_NIGHT, ITEM_EMPATHY_ROCK, SPECIES_CHIMECHO, 0}},
	[SPECIES_CHIMECHO] =  		 {{EVO_MEGA, ITEM_CHIMECHITE, SPECIES_CHIMECHO_MEGA, 0}},
	...
	[SPECIES_MUNCHLAX] =         {{EVO_FRIENDSHIP, 0, SPECIES_SNORLAX, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_SNORLAX, 0}},
	[SPECIES_RIOLU] =            {{EVO_FRIENDSHIP_DAY, 0, SPECIES_LUCARIO, 0},
								  {EVO_ITEM_DAY, ITEM_EMPATHY_ROCK, SPECIES_LUCARIO, 0}},
	...
	[SPECIES_WOOBAT] =           {{EVO_FRIENDSHIP, 0, SPECIES_SWOOBAT, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_SWOOBAT, 0}},
	...
	[SPECIES_SWADLOON] =         {{EVO_FRIENDSHIP, 0, SPECIES_LEAVANNY, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_LEAVANNY, 0}},
	...
	[SPECIES_PETILIL] =          {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT, 0},
								  {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_LILLIGANT_H, 0}},
	...
	[SPECIES_TALONFLAME] =  	 {{EVO_MEGA, ITEM_TALONFLITE, SPECIES_TALONFLAME_MEGA, 0}},
	...
	[SPECIES_GOOMY] =            {{EVO_LEVEL_DAY, 40, SPECIES_SLIGGOO, 0},
	...
	[SPECIES_CHARJABUG] =        {{EVO_MAP, MAP_NAME_POWER_PLANT, SPECIES_VIKAVOLT, 0}},
	[SPECIES_CRABRAWLER] =       {{EVO_MAP, MAP_NAME_SEAFOAM_ISLANDS, SPECIES_CRABOMINABLE, 0}},
	...
	[SPECIES_STEENEE] =          {{EVO_MOVE, MOVE_STOMP, SPECIES_TSAREENA, 0},
								  {EVO_MOVE_TYPE, TYPE_DARK, SPECIES_TSAREENA_S, 0}},
	...
	[SPECIES_TYPE_NULL] =        {{EVO_FRIENDSHIP, 0, SPECIES_SILVALLY, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_SILVALLY, 0}},
	...
	[SPECIES_MEOWTH_A] =         {{EVO_FRIENDSHIP, 0, SPECIES_PERSIAN_A, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_PERSIAN_A, 0}},
	...
	[SPECIES_GOSSIFLEUR] =       {{EVO_LEVEL, 20, SPECIES_ELDEGOSS, 0},
								  {EVO_RAINY_FOGGY_OW, 20, SPECIES_ELDEGOSS_S, 0}},
	...
	[SPECIES_APPLIN] =           {{EVO_ITEM, ITEM_TART_APPLE, SPECIES_FLAPPLE, 0},
								  ...
								  {EVO_LEVEL_NIGHT, 30, SPECIES_APPLERAVE, 0}},
...
//	[SPECIES_ALCREMIE_STRAWBERRY] = {{EVO_GIGANTAMAX, TRUE, SPECIES_ALCREMIE_GIGA, 0}},
	[SPECIES_SNOM] =             {{EVO_FRIENDSHIP_NIGHT, 0, SPECIES_FROSMOTH, 0},
								  {EVO_ITEM_NIGHT, ITEM_EMPATHY_ROCK, SPECIES_FROSMOTH, 0}},
	...
	[SPECIES_FARFETCHD_G] =      {{EVO_FRIENDSHIP, 0, SPECIES_SIRFETCHD, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_SIRFETCHD, 0}},
	...
	[SPECIES_STANTLER] = 		 {{EVO_LEVEL, 30, SPECIES_WYRDEER, 0}},
	[SPECIES_URSARING] =  		 {{EVO_ITEM, ITEM_PEAT_BLOCK, SPECIES_URSALUNA, 0}},
	[SPECIES_BASCULIN_WHITE] =   {{EVO_MALE_LEVEL, 34, SPECIES_BASCULEGION, 0},
								  {EVO_FEMALE_LEVEL, 34, SPECIES_BASCULEGION_FEMALE, 0}},
	...
	[SPECIES_LECHONK] =          {{EVO_MALE_LEVEL, 18, SPECIES_OINKOLOGNE, 0},
							  	  {EVO_FEMALE_LEVEL, 18, SPECIES_OINKOLOGNE_F, 0}},	
    #ifdef MOVE_HYPERDRILL
    ...
    [SPECIES_RELLOR] = 			 {{EVO_FRIENDSHIP, 0, SPECIES_RABSCA, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_RABSCA, 0}}, 
    ...
    [SPECIES_FINIZEN] = 		 {{EVO_TRADE, 0, SPECIES_PALAFIN, 0},
								  {EVO_ITEM, ITEM_LINK_CABLE, SPECIES_PALAFIN, 0}},
    ...
    [SPECIES_TANDEMAUS] = 		 {{EVO_LEVEL_SILCOON, 25, SPECIES_MAUSHOLD, 0},
								  {EVO_LEVEL_CASCOON, 25, SPECIES_MAUSHOLD_FOUR, 0}},
	...
	[SPECIES_PAWMO] = 			 {{EVO_FRIENDSHIP, 0, SPECIES_PAWMOT, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_PAWMOT, 0}},
	...
	[SPECIES_BRAMBLIN] = 		 {{EVO_FRIENDSHIP, 0, SPECIES_BRAMBLEGHAST, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_BRAMBLEGHAST, 0}},
	...
	[SPECIES_CHARCADET] = 		 {
								 #ifdef ITEM_AUSPICIOUS_ARMOR
								 {EVO_ITEM, ITEM_AUSPICIOUS_ARMOR, SPECIES_ARMAROUGE, 0},
								 #else
								 {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_ARMAROUGE, 0},
								 #endif
								 #ifdef ITEM_MALICIOUS_ARMOR
	...
	[SPECIES_BISHARP] = 		 {{EVO_LEVEL_HOLD_ITEM, 64, SPECIES_KINGAMBIT, ITEM_LEADERS_CREST}},
    [SPECIES_WOOPER_P] = 		 {{EVO_LEVEL, 20, SPECIES_CLODSIRE, 0}},
    [SPECIES_PRIMEAPE] = 		 {{EVO_LEVEL, 55, SPECIES_ANNIHILAPE, 0}},

	[SPECIES_CEBULACK] = 		 {{EVO_LEVEL, 16, SPECIES_CEBULBA, 0}},
	[SPECIES_CEBULBA] = 		 {{EVO_LEVEL, 36, SPECIES_CEBOGRE, 0}},
	[SPECIES_SHARIK] = 		 	 {{EVO_LEVEL, 16, SPECIES_SHARKADE, 0}},
	[SPECIES_SHARKADE] = 		 {{EVO_LEVEL, 36, SPECIES_SHARKANO, 0}},
	[SPECIES_RABBLIT] = 		 {{EVO_LEVEL, 16, SPECIES_PYROSE, 0}},
	[SPECIES_PYROSE] = 		 	 {{EVO_LEVEL, 36, SPECIES_DOYEBUNNY, 0}},
	[SPECIES_EMBIRD] = 		 	 {{EVO_LEVEL, 22, SPECIES_TORCHAWK, 0}},
	[SPECIES_TORCHAWK] = 		 {{EVO_LEVEL, 40, SPECIES_BURSTWING, 0}},
	[SPECIES_MOLEKID] = 		 {{EVO_LEVEL, 30, SPECIES_MOLEBULK, 0}},
	[SPECIES_CARAXIC] =  		 {{EVO_LEVEL, 28, SPECIES_VELYNX, 0}},
	[SPECIES_DUCKLETT_S] =  	 {{EVO_LEVEL, 35, SPECIES_FLAPPICE, 0}},
	[SPECIES_KOMORDON] =   		 {{EVO_MALE_LEVEL, 32, SPECIES_BASIBLAZE, 0},
								  {EVO_FEMALE_LEVEL, 32, SPECIES_LIZEMBRA, 0}},
    [SPECIES_SPIRISCRUFF] =      {{EVO_MOVE, MOVE_RAPIDSPIN, SPECIES_SPIRIPALM, 0}},
    [SPECIES_POOCHYENA_S] =      {{EVO_LEVEL, 18, SPECIES_MIGHTYENA_S, 0}},
    [SPECIES_MIGHTYENA_S] =      {{EVO_LEVEL, 38, SPECIES_JUNGYENA, 0}},
    [SPECIES_BULBASAUR_S] =      {{EVO_LEVEL, 16, SPECIES_IVYSAUR_S, 0}},
	[SPECIES_IVYSAUR_S] =        {{EVO_LEVEL, 32, SPECIES_VENUSAUR_S, 0}},
	[SPECIES_SANDSHREW_S] =      {{EVO_LEVEL, 22, SPECIES_SANDSLASH_S, 0}},
	[SPECIES_ZUBAT_S] =          {{EVO_LEVEL, 22, SPECIES_GOLBAT_S, 0}},
	[SPECIES_GOLBAT_S] =         {{EVO_LEVEL, 40, SPECIES_CROBAT_S, 0}},
	[SPECIES_PARAS_S] =          {{EVO_LEVEL, 24, SPECIES_PARASECT_S, 0}},
	[SPECIES_MANKEY_S] =         {{EVO_LEVEL, 28, SPECIES_PRIMEAPE_S, 0}},
	[SPECIES_ABRA_S] =           {{EVO_LEVEL, 16, SPECIES_KADABRA_S, 0}},
	[SPECIES_KADABRA_S] =        {{EVO_ITEM, ITEM_REAPER_CLOTH, SPECIES_ALAKAZAM_S, 0}},
	[SPECIES_ALAKAZAM_S] =       {{EVO_MEGA, ITEM_ALAKAZITE_S, SPECIES_ALAKAZAM_S_MEGA, MEGA_VARIANT_STANDARD}},
	[SPECIES_GEODUDE_S] =        {{EVO_LEVEL, 25, SPECIES_GRAVELER_S, 0}},
	[SPECIES_GRAVELER_S] =       {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_GOLEM_S, 0}},
	[SPECIES_DODUO_S] =          {{EVO_LEVEL, 31, SPECIES_DODRIO_S, 0}},
	[SPECIES_GRIMER_S] =         {{EVO_LEVEL, 38, SPECIES_MUK_S, 0}},
	[SPECIES_GASTLY_S] =         {{EVO_LEVEL, 25, SPECIES_HAUNTER_S, 0}},
	[SPECIES_HAUNTER_S] =        {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_GENGAR_S, 0}},
	[SPECIES_VOLTORB_S] =  		 {{EVO_ITEM, ITEM_LINK_CABLE, SPECIES_ELECTRODE_S, 0}},
	[SPECIES_KOFFING_S] =        {{EVO_LEVEL, 35, SPECIES_WEEZING_S, 0}},
	[SPECIES_MAGBY_S] =          {{EVO_LEVEL, 30, SPECIES_MAGMAR_S, 0}},
	[SPECIES_MAGMAR_S] =         {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_MAGMORTAR_S, 0}},
	[SPECIES_MAGIKARP_S] =       {{EVO_LEVEL, 20, SPECIES_GYARADOS_S, 0}},
	[SPECIES_CHIKORITA_S] =      {{EVO_LEVEL, 16, SPECIES_BAYLEEF_S, 0}},
	[SPECIES_BAYLEEF_S] =        {{EVO_LEVEL, 32, SPECIES_MEGANIUM_S, 0}},
	[SPECIES_CYNDAQUIL_S] =      {{EVO_LEVEL, 14, SPECIES_QUILAVA_S, 0}},
	[SPECIES_QUILAVA_S] =        {{EVO_LEVEL, 36, SPECIES_TYPHLOSION_S, 0}},
	[SPECIES_TOTODILE_S] =       {{EVO_LEVEL, 18, SPECIES_CROCONAW_S, 0}},
	[SPECIES_CROCONAW_S] =       {{EVO_LEVEL, 30, SPECIES_FERALIGATR_S, 0}},
	[SPECIES_WOOPER_S] =         {{EVO_LEVEL, 20, SPECIES_QUAGSIRE_S, 0}},
	[SPECIES_WYNAUT_S] =         {{EVO_LEVEL, 15, SPECIES_WOBBUFFET_S, 0}},
	[SPECIES_SLUGMA_S] =         {{EVO_LEVEL, 38, SPECIES_MAGCARGO_S, 0}},	
	[SPECIES_SWINUB_S] =         {{EVO_LEVEL, 33, SPECIES_PILOSWINE_S, 0}},
	[SPECIES_PILOSWINE_S] =      {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_MAMOSWINE_S, 0}},
	[SPECIES_TORCHIC_S] =        {{EVO_LEVEL, 16, SPECIES_COMBUSKEN_S, 0}},
	[SPECIES_COMBUSKEN_S] =      {{EVO_LEVEL, 36, SPECIES_BLAZIKEN_S, 0}},
	[SPECIES_SHROOMISH_S] =      {{EVO_LEVEL, 23, SPECIES_BRELOOM_S, 0}},
	[SPECIES_NUMEL_S] =          {{EVO_LEVEL, 33, SPECIES_CAMERUPT_S, 0}},
	[SPECIES_SNORUNT_S] =        {{EVO_LEVEL, 42, SPECIES_GLALIE_S, 0}},
	[SPECIES_BIDOOF_S] =         {{EVO_LEVEL, 15, SPECIES_BIBAREL_S, 0}},
	[SPECIES_BUNEARY_S] =        {{EVO_FRIENDSHIP, 0, SPECIES_LOPUNNY_S, 0},
								  {EVO_ITEM, ITEM_EMPATHY_ROCK, SPECIES_LOPUNNY_S, 0}},
	[SPECIES_LOPUNNY_S] =        {{EVO_MEGA, ITEM_LOPUNNITE_S, SPECIES_LOPUNNY_S_MEGA, MEGA_VARIANT_STANDARD}},
	[SPECIES_GIBLE_S] =          {{EVO_LEVEL, 24, SPECIES_GABITE_S, 0}},
	[SPECIES_GABITE_S] =         {{EVO_LEVEL, 48, SPECIES_GARCHOMP_S, 0}},
	[SPECIES_COTTONEE_S] =       {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_WHIMSICOTT_S, 0}},
	[SPECIES_SCRAGGY_S] =        {{EVO_LEVEL, 39, SPECIES_SCRAFTY_S, 0}},
	[SPECIES_ELGYEM_S] =         {{EVO_LEVEL, 42, SPECIES_BEHEEYEM_S, 0}},
	[SPECIES_AXEW_S] =           {{EVO_LEVEL, 38, SPECIES_FRAXURE_S, 0}},
	[SPECIES_FRAXURE_S] =        {{EVO_LEVEL, 48, SPECIES_HAXORUS_S, 0}},
	[SPECIES_SKIDDO_S] =         {{EVO_LEVEL, 32, SPECIES_GOGOAT_S, 0}},
	[SPECIES_STUFFUL_S] =        {{EVO_LEVEL, 27, SPECIES_BEWEAR_S, 0}},
	[SPECIES_SANDYGAST_S] =      {{EVO_LEVEL, 42, SPECIES_PALOSSAND_S, 0}},
	[SPECIES_NICKIT_S] =         {{EVO_LEVEL, 18, SPECIES_THIEVUL_S, 0}},
	[SPECIES_WOOLOO_S] =         {{EVO_LEVEL, 24, SPECIES_DUBWOOL_S, 0}},
	[SPECIES_TOXEL_S] =          {{EVO_LEVEL, 30, SPECIES_TOXTRICITY_S, 0}},

	[SPECIES_ALAKAZAM_S_MEGA] =  {{EVO_MEGA, ITEM_NONE, SPECIES_ALAKAZAM_S, MEGA_VARIANT_STANDARD}},
	[SPECIES_LANTURN_MEGA] =  	 {{EVO_MEGA, ITEM_NONE, SPECIES_LANTURN, MEGA_VARIANT_STANDARD}},
	[SPECIES_OCTILLERY_MEGA] =   {{EVO_MEGA, ITEM_NONE, SPECIES_OCTILLERY, MEGA_VARIANT_STANDARD}},
	[SPECIES_SMEARGLE] =  		 {{EVO_MEGA, ITEM_SMEARGLITE, SPECIES_SMEARGLE_MEGA, MEGA_VARIANT_STANDARD}},
	[SPECIES_SMEARGLE_MEGA] =  	 {{EVO_MEGA, ITEM_NONE, SPECIES_SMEARGLE, MEGA_VARIANT_STANDARD}},
	[SPECIES_SWELLOW_MEGA] =  	 {{EVO_MEGA, ITEM_NONE, SPECIES_SWELLOW, MEGA_VARIANT_STANDARD}},
	[SPECIES_CHIMECHO_MEGA] =  	 {{EVO_MEGA, ITEM_NONE, SPECIES_CHIMECHO, MEGA_VARIANT_STANDARD}},
	[SPECIES_TALONFLAME_MEGA] =  {{EVO_MEGA, ITEM_NONE, SPECIES_TALONFLAME, MEGA_VARIANT_STANDARD}},
	[SPECIES_LOPUNNY_S_MEGA] =   {{EVO_MEGA, ITEM_NONE, SPECIES_LOPUNNY_S, MEGA_VARIANT_STANDARD}},
	[SPECIES_CARBINK] =   		 {{EVO_MEGA, ITEM_CARBINKITE, SPECIES_CARBINK_MEGA, MEGA_VARIANT_STANDARD}},
	[SPECIES_CARBINK_MEGA] =  	 {{EVO_MEGA, ITEM_NONE, SPECIES_CARBINK, MEGA_VARIANT_STANDARD}},
	...
	[SPECIES_ROTOM] = 			 {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_ROTOM_WASH, 0},
								  ...
								  {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_ROTOM_FAN, 0},
								  },
    ...
    [SPECIES_ROTOM_HEAT] = 		 {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_ROTOM_WASH, 0},
								  {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_ROTOM, 0},
								  {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_ROTOM_MOW, 0},
								  {EVO_ITEM, ITEM_ICE_STONE, SPECIES_ROTOM_FROST, 0},
								  {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_ROTOM_FAN, 0},
								  },

    [SPECIES_ROTOM_MOW] = 		 {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_ROTOM_WASH, 0},
								  {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ROTOM_HEAT, 0},
								  {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_ROTOM, 0},
								  {EVO_ITEM, ITEM_ICE_STONE, SPECIES_ROTOM_FROST, 0},
								  {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_ROTOM_FAN, 0},
    ...
    [SPECIES_ROTOM_FROST] = 	 {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_ROTOM_WASH, 0},
								  {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ROTOM_HEAT, 0},
								  {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_ROTOM_MOW, 0},
								  {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_ROTOM, 0},
								  {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_ROTOM_FAN, 0},
    ...
    [SPECIES_ROTOM_FAN] = 		 {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_ROTOM_WASH, 0},
								  {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_ROTOM_HEAT, 0},
								  {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_ROTOM_MOW, 0},
								  {EVO_ITEM, ITEM_ICE_STONE, SPECIES_ROTOM_FROST, 0},
								  {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_ROTOM, 0},
	...
	[SPECIES_DEMOLETT_SHELTER] = {{EVO_LEVEL, 100, SPECIES_DEMOLETT, 0}},
};
