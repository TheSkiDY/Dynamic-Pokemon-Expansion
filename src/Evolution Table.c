...
//	[SPECIES_ALCREMIE_STRAWBERRY] = {{EVO_GIGANTAMAX, TRUE, SPECIES_ALCREMIE_GIGA, 0}},
	...
	[SPECIES_SANDSHREW_S] = 	{{EVO_LEVEL, 28, SPECIES_SANDSLASH_S, 0}},
	[SPECIES_ZUBAT_S] = 		{{EVO_LEVEL, 16, SPECIES_GOLBAT_S, 0}},
	[SPECIES_GOLBAT_S] = 		{{EVO_LEVEL, 36, SPECIES_CROBAT_S, 0}},
	[SPECIES_CEBULACK] = 		{{EVO_LEVEL, 18, SPECIES_CEBULBA, 0}},
	[SPECIES_CEBULBA] = 		{{EVO_LEVEL, 36, SPECIES_CEBOGRE, 0}},
	[SPECIES_SHARIK] = 			{{EVO_LEVEL, 18, SPECIES_SHARKADE, 0}},
	[SPECIES_SHARKADE] = 		{{EVO_LEVEL, 36, SPECIES_SHARKANO, 0}},
	[SPECIES_AXEW_S] = 			{{EVO_LEVEL, 22, SPECIES_FRAXURE_S, 0}},
	[SPECIES_FRAXURE_S] = 		{{EVO_LEVEL, 40, SPECIES_HAXORUS_S, 0}},
	[SPECIES_GEODUDE_S] = 		{{EVO_LEVEL, 18, SPECIES_GRAVELER_S, 0}},
	[SPECIES_GRAVELER_S] = 		{{EVO_LEVEL, 36, SPECIES_GOLEM_S, 0}},
	[SPECIES_DODUO_S] = 		{{EVO_LEVEL, 30, SPECIES_DODRIO_S, 0}},
	[SPECIES_FARPUSSD] = 		{{EVO_LEVEL, 22, SPECIES_FARAWAYD, 0}},
	[SPECIES_FARAWAYD] = 		{{EVO_LEVEL, 40, SPECIES_FARQUAAD, 0}},
	[SPECIES_GRIMER_S] = 		{{EVO_LEVEL, 28, SPECIES_MUK_S, 0}},
	[SPECIES_GASTLY_S] = 		{{EVO_LEVEL, 20, SPECIES_HAUNTER_S, 0}},
	[SPECIES_HAUNTER_S] = 		{{EVO_LEVEL, 44, SPECIES_GENGAR_S, 0}},
	[SPECIES_VOLTORB_S] = 		{{EVO_LEVEL, 30, SPECIES_ELECTRODE_S, 0}},
	[SPECIES_KOFFING_S] = 		{{EVO_LEVEL, 38, SPECIES_WEEZING_S, 0}},
	[SPECIES_MOLEKID] = 		{{EVO_LEVEL, 34, SPECIES_MOLEBULK, 0}},
	[SPECIES_MAGBY_S] = 		{{EVO_LEVEL, 20, SPECIES_MAGMAR_S, 0}},
	[SPECIES_MAGMAR_S] = 		{{EVO_LEVEL, 40, SPECIES_MAGMORTAR_S, 0}},
	[SPECIES_RABBLIT] = 		{{EVO_LEVEL, 20, SPECIES_PYROSE, 0}},
	[SPECIES_PYROSE] = 			{{EVO_LEVEL, 40, SPECIES_DOYEBUNNY, 0}},
	[SPECIES_MARACTUS_S] = 		{{EVO_LEVEL, 101, SPECIES_MARACTUS_S, 0}},
};
