...
const struct PokedexEntry gPokedexEntries[NATIONAL_DEX_COUNT] =
{
	...
	{
		.categoryName = {_G, _R, _A, _S, _S, _SPACE, _C, _A, _T, _END, _END, _END},
		.height = 4,
		.weight = 41,
	...
	{
		.categoryName = {_M, _A, _G, _I, _C, _I, _A, _N, _END, _END, _END, _END},
		.height = 15,
		.weight = 312,
	...
	{
		.categoryName = {_F, _I, _R, _E, _SPACE, _C, _R, _O, _C, _END, _END, _END},
		.height = 4,
		.weight = 98,
	...
	{
		.categoryName = {_S, _I, _N, _G, _E, _R, _END, _END, _END, _END, _END, _END},
		.height = 16,
		.weight = 3265,
	...
	[NATIONAL_DEX_QUAXLY] = 
	{
		.categoryName = {_D, _U, _C, _K, _L, _I, _N, _G, _END, _END, _END, _END},
		.height = 5,
		.weight = 61,
	...
	{
		.categoryName = {_P, _R, _A, _C, _T, _I, _C, _I, _N, _G, _END, _END},
		.height = 12,
		.weight = 215,
	...
	{
		.categoryName = {_D, _A, _N, _C, _E, _R, _END, _END, _END, _END, _END, _END},
		.height = 18,
		.weight = 619,
	...
	{
		.categoryName = {_H, _O, _G, _END, _END, _END, _END, _END, _END, _END, _END, _END},
		.height = 5,
		.weight = 102,
	...
	{
		.categoryName = {_T, _R, _A, _P, _END, _END, _END, _END, _END, _END, _END, _END},
		.height = 10,
		.weight = 165,
	...
	[NATIONAL_DEX_PAWMI] = 
	{
		.categoryName = {_M, _O, _U, _S, _E, _END, _END, _END, _END, _END, _END, _END},
		.height = 3,
		.weight = 25,
	...
	[NATIONAL_DEX_PAWMOT] = 
	{
		.categoryName = {_H, _A, _N, _D, _S, _HYPHEN, _O, _N, _END, _END, _END, _END},
		.height = 9,
		.weight = 410,
	...
	{
		.categoryName = {_C, _O, _U, _P, _L, _E, _END, _END, _END, _END, _END, _END},
		.height = 3,
		.weight = 18,
	...
	{
		.categoryName = {_F, _A, _M, _I, _L, _Y, _END, _END, _END, _END, _END, _END},
		.height = 3,
		.weight = 23,
	...
	{
		.categoryName = {_P, _U, _P, _P, _Y, _END, _END, _END, _END, _END, _END, _END},
		.height = 3,
		.weight = 109,
	...
	{
		.categoryName = {_D, _O, _G, _END, _END, _END, _END, _END, _END, _END, _END, _END},
		.height = 5,
		.weight = 149,
	...
	[NATIONAL_DEX_SMOLIV] = 
	{
		.categoryName = {_O, _L, _I, _V, _E, _END, _END, _END, _END, _END, _END, _END},
		.height = 3,
		.weight = 65,
	...
	{
		.categoryName = {_P, _A, _R, _R, _O, _T, _END, _END, _END, _END, _END, _END},
		.height = 6,
		.weight = 24,
	...
	[NATIONAL_DEX_NACLI] = 
	{
		.categoryName = {_R, _O, _C, _K, _SPACE, _S, _A, _L, _T, _END, _END, _END},
		.height = 4,
		.weight = 160,
	...
	{
		.categoryName = {_F, _I, _R, _E, _SPACE, _C, _H, _I, _L, _D, _END, _END},
		.height = 60,
		.weight = 105,
	...
	{
		.categoryName = {_E, _L, _E, _T, _A, _D, _P, _O, _L, _E, _END, _END},
		.height = 3,
		.weight = 4,
	...
	{
		.categoryName = {_E, _L, _E, _F, _R, _O, _G, _END, _END, _END, _END, _END},
		.height = 12,
		.weight = 1130,
	...
	{
		.categoryName = {_L, _A, _N, _D, _SPACE, _S, _N, _A, _K, _E, _END, _END},
		.height = 36,
		.weight = 392,
	...
	{
		.categoryName = {_L, _O, _N, _G, _SPACE, _N, _E, _C, _K, _END, _END, _END},
		.height = 32,
		.weight = 1600,
	...
	{
		.categoryName = {_R, _A, _S, _C, _A, _L, _END, _END, _END, _END, _END, _END},
		.height = 5,
		.weight = 160,
	...
	{
		.categoryName = {_B, _O, _S, _S, _END, _END, _END, _END, _END, _END, _END, _END},
		.height = 11,
		.weight = 610,
	...
	{
		.categoryName = {_T, _U, _M, _B, _L, _E, _W, _E, _E, _D, _END, _END},
		.height = 6,
		.weight = 6,
	...
	{
		.categoryName = {_W, _O, _O, _D, _E, _A, _R, _END, _END, _END, _END, _END},
		.height = 9,
		.weight = 330,
	...
	[NATIONAL_DEX_KLAWF] = 
	{
		.categoryName = {_A, _M, _B, _U, _S, _H, _END, _END, _END, _END, _END, _END},
		.height = 13,
		.weight = 790,
	...
	[NATIONAL_DEX_RELLOR] = 
	{
		.categoryName = {_R, _O, _L, _L, _I, _N, _G, _END, _END, _END, _END, _END},
		.height = 2,
		.weight = 10,
	...
	{
		.categoryName = {_F, _R, _I, _L, _L, _END, _END, _END, _END, _END, _END, _END},
		.height = 2,
		.weight = 15,
	...
	{
		.categoryName = {_O, _S, _T, _R, _I, _C, _H, _END, _END, _END, _END, _END},
		.height = 19,
		.weight = 900,
	...
	{
		.categoryName = {_M, _E, _T, _A, _L, _S, _M, _I, _T, _H, _END, _END},
		.height = 4,
		.weight = 89,
	...
	{
		.categoryName = {_H, _A, _M, _M, _E, _R, _END, _END, _END, _END, _END, _END},
		.height = 7,
		.weight = 591,
	...
	{
		.categoryName = {_G, _A, _R, _D, _E, _N, _SPACE, _E, _E, _L, _END, _END},
		.height = 12,
		.weight = 18,
	...
	{
		.categoryName = {_I, _T, _E, _M, _SPACE, _D, _R, _O, _P, _END, _END, _END},
		.height = 15,
		.weight = 429,
	...
	{
		.categoryName = {_D, _O, _L, _P, _H, _I, _N, _END, _END, _END, _END, _END},
		.height = 13,
		.weight = 602,
	...
	[NATIONAL_DEX_VAROOM] = 
	{
		.categoryName = {_S, _I, _N, _G, _L, _E, _HYPHEN, _C, _Y, _L, _END, _END},
		.height = 10,
		.weight = 350,
	...
	{
		.categoryName = {_M, _U, _L, _T, _I, _HYPHEN, _C, _Y, _L, _END, _END, _END},
		.height = 18,
		.weight = 1200,
	...
	{
		.categoryName = {_M, _O, _U, _N, _T, _END, _END, _END, _END, _END, _END, _END},
		.height = 16,
		.weight = 630,
	...
	{
		.categoryName = {_E, _A, _R, _T, _H, _W, _O, _R, _M, _END, _END, _END},
		.height = 25,
		.weight = 3100,
	...
	{
		.categoryName = {_O, _R, _E, _END, _END, _END, _END, _END, _END, _END, _END, _END},
		.height = 7,
		.weight = 80,
	...
	{
		.categoryName = {_G, _H, _O, _S, _T, _SPACE, _D, _O, _G, _END, _END, _END},
		.height = 60,
		.weight = 350,
	...
	{
		.categoryName = {_B, _I, _G, _SPACE, _B, _L, _A, _D, _E, _END, _END, _END},
		.height = 20,
		.weight = 1200,
	...
	[NATIONAL_DEX_VELUZA] = 
	{
		.categoryName = {_J, _E, _T, _T, _I, _S, _O, _N, _END, _END, _END, _END},
		.height = 25,
		.weight = 900,
	...
	{
		.categoryName = {_M, _I, _M, _I, _C, _R, _Y, _END, _END, _END, _END, _END},
		.height = 3,
		.weight = 80,
	...
	{
		.categoryName = {_P, _A, _R, _A, _D, _O, _X, _END, _END, _END, _END, _END},
		.height = 22,
		.weight = 3200,
	...
	{
		.categoryName = {_I, _C, _E, _SPACE, _F, _I, _N, _END, _END, _END, _END, _END},
		.height = 5,
		.weight = 170,
	...
	{
		.categoryName = {_I, _C, _E, _SPACE, _D, _R, _A, _G, _O, _N, _END, _END},
		.height = 21,
		.weight = 2100,
	...
	{
		.categoryName = {_C, _O, _I, _N, _SPACE, _C, _H, _E, _S, _T, _END, _END},
		.height = 3,
		.weight = 50,
	...
	{
		.categoryName = {_R, _U, _I, _N, _O, _U, _S, _END, _END, _END, _END, _END},
		.height = 15,
		.weight = 742,
	...
	{
		 .categoryName = {_O, _N, _I, _O, _N, _END, _END, _END, _END, _END, _END, _END},
		.height = 3,
		.weight = 8,
	...
	[NATIONAL_DEX_SHARIK] = 
	{
		 .categoryName = {_S, _H, _A, _R, _K, _END, _END, _END, _END, _END, _END, _END},
		.height = 4,
		.weight = 165,
	...
	{
		 .categoryName = {_M, _E, _T, _A, _L, _SPACE, _S, _H, _A, _R, _K, _END},
		.height = 34,
		.weight = 3400,
	...
	{
		 .categoryName = {_B, _L, _U, _E, _SPACE, _F, _L, _A, _M, _E, _END, _END},
		.height = 6,
		.weight = 33,
	...
	[NATIONAL_DEX_EMBIRD] = 
	{
		 .categoryName = {_F, _I, _R, _E, _SPACE, _D, _U, _C, _K, _END, _END, _END},
		.height = 8,
		.weight = 75,
		.description = DEX_ENTRY_EMBIRD,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_TORCHAWK] = 
	{
		 .categoryName = {_F, _I, _R, _E, _SPACE, _H, _A, _W, _K, _END, _END, _END},
		.height = 17,
		.weight = 392,
		.description = DEX_ENTRY_TORCHAWK,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_BURSTWING] = 
	{
		 .categoryName = {_F, _L, _A, _M, _E, _SPACE, _B, _I, _R, _D, _END, _END},
		.height = 24,
		.weight = 652,
		.description = DEX_ENTRY_BURSTWING,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_TUCAM] = 
	{
		 .categoryName = {_C, _L, _O, _U, _D, _L, _E, _T, _END, _END, _END, _END},
		.height = 6,
		.weight = 2,
	...
	[NATIONAL_DEX_DOREKEY] = 
	{
		 .categoryName = {_R, _O, _C, _K, _SPACE, _D, _O, _N, _K, _E, _Y, _END},
		.height = 17,
		.weight = 800,
		.description = DEX_ENTRY_DOREKEY,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_MAGICLOUD] = 
	{
		 .categoryName = {_C, _L, _O, _U, _D, _END, _END, _END, _END, _END, _END, _END},
		.height = 5,
		.weight = 4,
		.description = DEX_ENTRY_MAGICLOUD,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_OSTREECH] = 
	{
		 .categoryName = {_O, _S, _T, _R, _I, _C, _H, _END, _END, _END, _END, _END},
		.height = 20,
		.weight = 900,
		.description = DEX_ENTRY_OSTREECH,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_TURTRES] = 
	{
		 .categoryName = {_T, _U, _R, _T, _L, _E, _END, _END, _END, _END, _END, _END},
		.height = 3,
		.weight = 420,
		.description = DEX_ENTRY_TURTRES,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_CARAXIC] = 
	{
		 .categoryName = {_I, _C, _E, _SPACE, _W, _O, _L, _F, _END, _END, _END, _END},
		.height = 5,
		.weight = 100,
		.description = DEX_ENTRY_CARAXIC,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_PUFFINIGHT] = 
	{
		 .categoryName = {_P, _U, _F, _F, _I, _N, _END, _END, _END, _END, _END, _END},
		.height = 8,
		.weight = 12,
		.description = DEX_ENTRY_PUFFINIGHT,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_FLAPPICE] = 
	{
		 .categoryName = {_I, _C, _E, _SPACE, _B, _I, _R, _D, _END, _END, _END, _END},
		.height = 11,
		.weight = 121,
		.description = DEX_ENTRY_FLAPPICE,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_KOMORDON] = 
	{
		 .categoryName = {_F, _I, _R, _E, _SPACE, _L, _I, _Z, _A, _R, _D, _END},
		.height = 6,
		.weight = 60,
		.description = DEX_ENTRY_KOMORDON,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_LIZEMBRA] = 
	{
		 .categoryName = {_F, _I, _R, _E, _SPACE, _L, _I, _Z, _A, _R, _D, _END},
		.height = 18,
		.weight = 542,
		.description = DEX_ENTRY_LIZEMBRA,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_BASIBLAZE] = 
	{
		 .categoryName = {_F, _I, _R, _E, _SPACE, _L, _I, _Z, _A, _R, _D, _END},
		.height = 17,
		.weight = 577,
		.description = DEX_ENTRY_BASIBLAZE,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_SPIRISCRUFF] = 
	{
		 .categoryName = {_P, _S, _Y, _SPACE, _S, _H, _E, _L, _L, _END, _END, _END},
		.height = 4,
		.weight = 60,
		.description = DEX_ENTRY_SPIRISCRUFF,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_SPIRIPALM] = 
	{
		 .categoryName = {_P, _S, _Y, _SPACE, _G, _O, _L, _E, _M, _END, _END, _END},
		.height = 20,
		.weight = 531,
		.description = DEX_ENTRY_SPIRIPALM,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	{
		.categoryName = {_T, _O, _M, _B, _SPACE, _M, _O, _L, _E, _END, _END, _END},
		.height = 5,
		.weight = 444,
	...
	[NATIONAL_DEX_JUNGYENA] = 
	{
		 .categoryName = {_G, _N, _A, _W, _END, _END, _END, _END, _END, _END, _END, _END},
		.height = 15,
		.weight = 526,
		.description = DEX_ENTRY_JUNGYENA,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_VESPIKING] = 
	{
		 .categoryName = {_B, _E, _E, _END, _END, _END, _END, _END, _END, _END, _END, _END},
		.height = 11,
		.weight = 405,
		.description = DEX_ENTRY_VESPIKING,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_APPLERAVE] = 
	{
		 .categoryName = {_P, _U, _T, _R, _I, _D, _A, _P, _P, _L, _E, _END},
		.height = 2,
		.weight = 9,
		.description = DEX_ENTRY_APPLERAVE,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_EPEP] = 
	{
		 .categoryName = {_A, _Q, _U, _A, _SPACE, _G, _I, _A, _N, _T, _END, _END},
		.height = 22,
		.weight = 1000,
	...
	[NATIONAL_DEX_SUICUNE_ANCIENT] =
	{
		.categoryName = {_P, _A, _R, _A, _D, _O, _X, _END, _END, _END, _END, _END},
		.height = 35,
		.weight = 2800,
		.description = DEX_ENTRY_SUICUNE_ANCIENT,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_VIRIZION_FUTURE] =
	{
		.categoryName = {_P, _A, _R, _A, _D, _O, _X, _END, _END, _END, _END, _END},
		.height = 15,
		.weight = 125,
		.description = DEX_ENTRY_VIRIZION_FUTURE,
		.unusedDescription = (const u8*) 0x8444cb1,
		.pokemonScale = 0,
		.pokemonOffset = 0,
		.trainerScale = 0,
	...
	[NATIONAL_DEX_NAH] = 
	{
		 .categoryName = {_O, _C, _E, _A, _N, _SPACE, _L, _O, _R, _D, _END, _END},
		.height = 38,
		.weight = 600,
...
const struct AlternateDexEntries gAlternateDexEntries[] =
{
	...
	ALTERNATE_ENTRY(WISHIWASHI_SCHOOLING),
	...
	ALTERNATE_ENTRY(TAUROS_P_BLAZE),
	ALTERNATE_ENTRY(TAUROS_P_AQUA),
	ALTERNATE_ENTRY(OINKOLOGNE_F),
	ALTERNATE_ENTRY(PALAFIN_HERO),
	ALTERNATE_ENTRY(MAUSHOLD_FOUR),
	ALTERNATE_ENTRY(TATSUGIRI_DROOPY),
	ALTERNATE_ENTRY(TATSUGIRI_STRETCHY),
	ALTERNATE_ENTRY(SQUAWKABILLY_BLUE),
	ALTERNATE_ENTRY(SQUAWKABILLY_YELLOW),
	ALTERNATE_ENTRY(SQUAWKABILLY_WHITE),

	ALTERNATE_ENTRY(BULBASAUR_S),
	ALTERNATE_ENTRY(IVYSAUR_S),
	ALTERNATE_ENTRY(VENUSAUR_S),
	...
	ALTERNATE_ENTRY(PARAS_S),
	ALTERNATE_ENTRY(PARASECT_S),
	ALTERNATE_ENTRY(MANKEY_S),
	ALTERNATE_ENTRY(PRIMEAPE_S),
	ALTERNATE_ENTRY(ABRA_S),
	ALTERNATE_ENTRY(KADABRA_S),
	ALTERNATE_ENTRY(ALAKAZAM_S),
	...
	ALTERNATE_ENTRY(MAGIKARP_S),
	ALTERNATE_ENTRY(GYARADOS_S),
	ALTERNATE_ENTRY(LAPRAS_S),
	ALTERNATE_ENTRY(SNORLAX_S),
	ALTERNATE_ENTRY(CHIKORITA_S),
	ALTERNATE_ENTRY(BAYLEEF_S),
	ALTERNATE_ENTRY(MEGANIUM_S),
	ALTERNATE_ENTRY(CYNDAQUIL_S),
	ALTERNATE_ENTRY(QUILAVA_S),
	ALTERNATE_ENTRY(TYPHLOSION_S),
	ALTERNATE_ENTRY(TOTODILE_S),
	ALTERNATE_ENTRY(CROCONAW_S),
	ALTERNATE_ENTRY(FERALIGATR_S),
	ALTERNATE_ENTRY(SUNFLORA_S),
	ALTERNATE_ENTRY(WOOPER_S),
	ALTERNATE_ENTRY(QUAGSIRE_S),
	ALTERNATE_ENTRY(WYNAUT_S),
	ALTERNATE_ENTRY(WOBBUFFET_S),
	ALTERNATE_ENTRY(HERACROSS_S),
	ALTERNATE_ENTRY(SLUGMA_S),
	ALTERNATE_ENTRY(MAGCARGO_S),
	ALTERNATE_ENTRY(SWINUB_S),
	ALTERNATE_ENTRY(PILOSWINE_S),
	ALTERNATE_ENTRY(MAMOSWINE_S),
	ALTERNATE_ENTRY(MILTANK_S),
	ALTERNATE_ENTRY(TORCHIC_S),
	ALTERNATE_ENTRY(COMBUSKEN_S),
	ALTERNATE_ENTRY(BLAZIKEN_S),
	ALTERNATE_ENTRY(POOCHYENA_S),
	ALTERNATE_ENTRY(MIGHTYENA_S),
	ALTERNATE_ENTRY(SHROOMISH_S),
	ALTERNATE_ENTRY(BRELOOM_S),
	ALTERNATE_ENTRY(DELCATTY_S),
	ALTERNATE_ENTRY(SABLEYE_S),
	ALTERNATE_ENTRY(MAWILE_S),
	ALTERNATE_ENTRY(NUMEL_S),
	ALTERNATE_ENTRY(CAMERUPT_S),
	ALTERNATE_ENTRY(SEVIPER_S),
	ALTERNATE_ENTRY(SNORUNT_S),
	ALTERNATE_ENTRY(GLALIE_S),
	ALTERNATE_ENTRY(FROSLASS_S),
	ALTERNATE_ENTRY(BIDOOF_S),
	ALTERNATE_ENTRY(BIBAREL_S),
	ALTERNATE_ENTRY(BUNEARY_S),
	ALTERNATE_ENTRY(LOPUNNY_S),
	ALTERNATE_ENTRY(GIBLE_S),
	ALTERNATE_ENTRY(GABITE_S),
	ALTERNATE_ENTRY(GARCHOMP_S),
	ALTERNATE_ENTRY(COTTONEE_S),
	ALTERNATE_ENTRY(WHIMSICOTT_S),
	ALTERNATE_ENTRY(MARACTUS_S),
	ALTERNATE_ENTRY(SCRAGGY_S),
	ALTERNATE_ENTRY(SCRAFTY_S),
	ALTERNATE_ENTRY(DUCKLETT_S),
	ALTERNATE_ENTRY(ELGYEM_S),
	ALTERNATE_ENTRY(BEHEEYEM_S),
	ALTERNATE_ENTRY(AXEW_S),
	ALTERNATE_ENTRY(FRAXURE_S),
	ALTERNATE_ENTRY(HAXORUS_S),
	ALTERNATE_ENTRY(SKIDDO_S),
	ALTERNATE_ENTRY(GOGOAT_S),
	ALTERNATE_ENTRY(HAWLUCHA_S),
	ALTERNATE_ENTRY(DIANCIE_SHADOW),
	ALTERNATE_ENTRY(ORICORIO_R),
	ALTERNATE_ENTRY(STUFFUL_S),
	ALTERNATE_ENTRY(BEWEAR_S),
	ALTERNATE_ENTRY(TSAREENA_S),
	ALTERNATE_ENTRY(COMFEY_S),
	ALTERNATE_ENTRY(SANDYGAST_S),
	ALTERNATE_ENTRY(PALOSSAND_S),
	ALTERNATE_ENTRY(KOMALA_S),
	ALTERNATE_ENTRY(NICKIT_S),
	ALTERNATE_ENTRY(THIEVUL_S),
	ALTERNATE_ENTRY(ELDEGOSS_S),
	ALTERNATE_ENTRY(WOOLOO_S),
	ALTERNATE_ENTRY(DUBWOOL_S),
	ALTERNATE_ENTRY(TOXEL_S),
	ALTERNATE_ENTRY(TOXTRICITY_S),
...
const struct AlternateDexEntries gAlternateDexCategories[] =
{
	...
	ALTERNATE_DEX_CATEGORY(CALYREX_ICE),
	ALTERNATE_DEX_CATEGORY(CALYREX_GHOST),
