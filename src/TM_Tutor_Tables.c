...
const u16 gMoveTutorMoves[NUM_MOVE_TUTOR_MOVES] =
{
	...
	MOVE_BUGBITE,			//14
	MOVE_SNATCH,			//15
	MOVE_DUALWINGBEAT,		//16
	MOVE_RISINGVOLTAGE,		//17
	MOVE_SYNTHESIS,			//18
	MOVE_SIGNALBEAM,		//19
	MOVE_GRAVITY,			//20
	MOVE_STEELBEAM,			//21
	MOVE_EXPANDINGFORCE,	//22
	MOVE_MAGNETRISE,		//23
	MOVE_BOUNCE,			//24
	MOVE_ROLEPLAY,			//25
	MOVE_IRONHEAD,			//26
	...
	MOVE_SCARYFACE,			//71
	MOVE_LASHOUT,			//72
	MOVE_MISTYEXPLOSION,	//73
	MOVE_STEELROLLER,		//74
	MOVE_SKITTERSMACK,		//75
	MOVE_AGILITY,			//76
	MOVE_NASTYPLOT,			//77
