...
const struct LevelUpMove* const gLevelUpLearnsets[NUM_SPECIES] =
{
	...
	[SPECIES_ARCHALUDON] = sEmptyMoveset,
	[SPECIES_DIPPLIN_EVO] = sEmptyMoveset,
	[SPECIES_LOYAL_THREE_MASTER] = sEmptyMoveset,
	[SPECIES_RAGING_BOLT] = sEmptyMoveset,
	[SPECIES_PARADOX_ENTEI] = sEmptyMoveset,
	[SPECIES_IRON_CROWN] = sEmptyMoveset,
	[SPECIES_PARADOX_TERRAKION] = sEmptyMoveset,
	[SPECIES_TERAPAGOS] = sEmptyMoveset,
	[SPECIES_TERAPAGOS_FORM_2] = sEmptyMoveset,
	[SPECIES_TERAPAGOS_FORM_3] = sEmptyMoveset,
	//New Species Go Here
